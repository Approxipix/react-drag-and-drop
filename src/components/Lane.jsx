...
import {LaneFooter, LaneHeader, ScrollableLane, Section, Title} from '../styles/Base.jsx'
...
class Lane extends Component {
  ...
  renderFooter = () => {
    ...
    if (collapsibleLanes && cards.length > 0) {
      return <LaneFooter onClick={this.toggleLaneCollapsed}>{<CollapseBtn />}</LaneFooter>
    }
  }
